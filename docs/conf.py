...
filename = os.path.join(os.path.dirname(__file__), '..', 'test_repo', 'VERSION')
...
def linkcode_resolve(domain, info):
    ...
    if os.path.isfile(os.path.join(os.path.dirname(__file__), '..', rel_filename + '.py')):
        return "https://github.com/KarrLab/test_repo/blob/master/{}.py".format(rel_filename)
    else:
        return "https://github.com/KarrLab/test_repo/blob/master/{}/__init__.py".format(rel_filename)
...
htmlhelp_basename = 'test_repo-doc'
...
latex_documents = [
    (master_doc, 'test_repo.tex', u'test_repo documentation',
     u'Karr Lab', 'manual'),
]
...
man_pages = [
    (master_doc, 'test_repo', u'test_repo documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'test_repo', u'test_repo documentation',
     author, 'test_repo', 'One line description of project.',
     'Miscellaneous'),
]
